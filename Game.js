class Game {
  ...
  start() {
    ...
    var obstacle2Positions = [
      { x: width / 2 - 60, y: height - 5000, image: obstacle2Image },
      { x: width / 2 + 300, y: height - 1730, image: obstacle2Image },
      { x: width / 2 - 290, y: height - 3480, image: obstacle2Image },
     
      { x: width / 2 - 160, y: height - 4500, image: obstacle2Image },
      { x: width / 2, y: height - 4300, image: obstacle2Image },
    ];
